...
void _submitRegistrationForm() async {
  if (_formKey.currentState!.validate() && _agreeToTerms) {
    try {
      ...
      // Store user data (name, username) in Firestore
      ...
      // Navigate to the login or home page after successful registration
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => LoginPage()), // Adjust with your login page
      );
